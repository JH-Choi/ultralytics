...
def main(opt):
    ...
    opt.weights = '/mnt/hdd/code/ARLproject/ultralytics/runs/detect/S2_D1N_v2_eval_D2N/weights/best.pt'
    # opt.weights = '/mnt/hdd/code/ARLproject/ultralytics/runs/detect/Detect_D1N_val_D1N/weights/best.pt'
    weights = opt.weights
    device = opt.device
    labels = opt.labels
    ...
    # sub_folder = 'TrainSetVideos'
    sub_folder = 'TestSetVideos'
    ...
    data_folder = f"/mnt/hdd/data/Okutama_Action/{sub_folder}/Drone1/Noon"
    ...
    for scene_idx in scene_idxs:
        source = os.path.join(data_folder, scene_idx + '.mp4')
