"""
https://github.com/AlexanderMelde/SPHAR-Dataset/blob/master/scripts/video_conversion/convert_to_mp4.py
...
BASE_FOLDER = '/mnt/hdd/data/Okutama_Action/TrainSetVideos/Drone1/'    # absolute or relative to script
IN_FOLDER = 'Morning'                 # relative to BASE_FOLDER
OUT_FOLDER = 'out'               # relative to BASE_FOLDER
IN_FILE_EXTENSION = 'mov'        # avi, mpg, MPG, mpeg, mov, mp4, MP4, ...
