# https://github.com/hitottiez/deepsort/blob/master/tools/eval_utils/load_vatic_label.py
...
def load_gt(gt_root, videoname, dataset_type='okutama'):
    ...
    for frame_idx, frame_df in df.groupby(5):
        if frame_idx == 0:  # frame_idx=0 has no detection results, it will be skipped 
            continue
