# https://github.com/hitottiez/deepsort/blob/master/tools/okutama_acteval.py
import os
import argparse
from action_recog.eval.eval_utils.action_master import ActionMaster
from action_recog.eval.eval_utils.load_vatic_label import load_gt
...
def main():
    ...
    video_name = '1.1.8'
    args.gt_root = '/mnt/hdd/data/Okutama_Action/TestSetFrames/Labels/MultiActionLabels/3840x2160/'
    gt = load_gt(
